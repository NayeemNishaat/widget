...
// Chapter: Get payment method by payment intent id
...
// Chapter: Create Customer
func (c *Card) CreateCustomer(pm, email string) (*stripe.Customer, string, error) { // Note: type of pm will be same as enail as we didn't define it here
	stripe.Key = c.Secret
